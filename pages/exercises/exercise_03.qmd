...
library(ggplot2)
  ...
  d <- data.frame(bought_items = c(3, 10, 25, 26, 29, 30, 32, 35, 35, 38, 45, 50))

d |> ggplot(aes(y = bought_items)) +
  ...
  ggtitle("Boxplot: Median, Q1, Q3 und Whiskers")
...
In der Vorlesung wurden verschiedene Verteilungsformen besprochen. Skizzieren Sie folgenden Formen von Hand: 
...
![1. Normalverteilung, 2. rechtsschiefe Verteilung, 3. linksschiefe Verteilung](img/dist3.6.jpg)
:::
