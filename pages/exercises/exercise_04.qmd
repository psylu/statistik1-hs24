...
$P\left(\left.Schirm\right|{Regen}\right)=\frac{20}{100}=0.2$

$P\left(\left.Schirm\right|\overline{Regen}\right)=\frac{30}{100}=0.3$

$P\left(Schirm\right)=\frac{30}{100}=0.3$

Somit ist gezeigt, dass in diesem Beispiel die Wahrscheinlichkeit einen Schirm dabei zu haben nicht unabhängig davon ist, ob es auf dem Weg zum Bahnhof geregnet hat. 
...
$P\left(\left.nein\right|{m}\right)=\frac{10}{160}=0.0625$
